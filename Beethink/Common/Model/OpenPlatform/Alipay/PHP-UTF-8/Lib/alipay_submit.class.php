...
class AlipaySubmit {
	...
	function buildRequestMysign($para_sort) {
		...
		$mysign = "";
		switch (strtoupper(trim($this->alipay_config['private_key_path']))) {
			case "RSA" :
	...
	function buildRequestParaToString($para_temp) {
		...
		//把参数组中所有元素，按照“参�?参数值”的模式用�?”字符拼接成字符串，并对字符串做urlencode编码
	 ...
	 * 注意：该功能PHP5环境及以上支持，因此必须服务器、本地电脑中装有支持DOMDocument、SSL的PHP配置环境。建议本地调试时使用PHP开发软�?
     * return 时间戳字符串
	 */
